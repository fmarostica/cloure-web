<?php
    ...
    $page_title = "";
    $default_lang = "es";
    $topic = isset($_GET["topic"]) ? $_GET["topic"] : "installing-cloure";
    ...
    switch ($lang) {
        case 'es':
            $page_title="Centro de soporte de cloure";
            break;
        
        default:
            $page_title="Cloure support center";
            break;
    }
...
<html lang=<?php echo $lang;?>>
    ...
    <body>
        ...
        ?>
        <article>
            <div class="helpbox-topics">
                <ul>
                    <?php
                        echo '<li><a href="/'.$lang.'-'.$country_code.'/help/installing-cloure">Descargar e instalar cloure</a></li>';
                        echo '<li><a href="/'.$lang.'-'.$country_code.'/help/creating-a-cloure-account">Creción de una cuenta en cloure</a></li>';
                    ?>
                </ul>
            </div>
            <div class="helpbox-main-container">
                <?php
                    include __DIR__."/inc/help/".$topic.".php";
                ?>
            </div>
        </article>
        <?php 
